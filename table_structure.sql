...
--
-- Host: 127.0.0.1    Database: mysql_project_schema
-- ------------------------------------------------------
...
CREATE TABLE `courses` (
  ...
  `courses_students_id` varchar(45) NOT NULL,
  `courses_professors_id` varchar(45) NOT NULL,
...
CREATE TABLE `grades` (
  ...
  `grades_points` varchar(45) NOT NULL,
...
CREATE TABLE `professors` (
  ...
  `professors_students_id` varchar(45) NOT NULL,
...
-- Dump completed on 2021-12-13 17:57:43
